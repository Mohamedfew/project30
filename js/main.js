...
let heroTitles = [
    "المعهد العالي للإدارة وتكنولوجيا المعلومات بكفر الشيخ يرحب بكم",
    ...
    "تعليم عملي ونظري مدمج لإعداد متميزين"
];
...
let data = [
    {img:"/img/العميد.jpg", name:"د/ رضا ابراهيم", job:" استاذ المحاسبة وعميد المعهد  "},
  {img:"/img/احمد2.jpg", name:"د/ أحمد رضوان", job:"وكيل المعهد لشؤون الطلاب وأستاذ الرياضيات المساعد  "},
  {img:"/img/عمرو.jpg", name:"د/ عمرو الشوري", job:"رئيس قسم علوم الحاسب وأستاذ نظم المعلومات المساعد "},
  {img:"/img/منال بلقاسي.jpg", name:"منال البلقاسي ", job:" وكيل المعهد لخدمة المجتمع وأستاذ نظم المعلومات المساعد"},
  {img:"/img/محمد2.jpg", name:"د/ محمد الشوادفي", job:" وكيل المعهد وعضو هيئة التدريس ورئيس هيئة الأعمال "},
  {img:"/img/ايمن.jpg", name:"د/ ايمن ابو النضر", job:" رئيس قسم نظم المعلومات "},
  {img:"/img/عبدالحميد.jpg", name:"د/ عبدالحميد العيسوي", job:" رئيس قسم المحاسبة المساعد"},
  {img:"/img/غندور.jpg", name:"د/ محمد الغندور", job:" رئيس قسم المحاسبة"}
];
